...
div.wiki_syntax a:hover {
  text-decoration: underline;
}

div.wiki_syntax a.intern_link {
  color: #56b04f;
}

div.wiki_syntax a.extern_link {
  background: transparent url(./styles/proglass/theme/images/wiki/link_icon.gif) 0px 1px no-repeat;
  padding: 1px 0px 1px 16px;
  color: #436976;
}

div.wiki_syntax a.wiki_top {
  background: transparent url(./styles/proglass/theme/images/wiki/tool-top.gif) 0px 1px no-repeat;
  padding: 1px 0px 1px 20px;
  color: #436976;
}

div.wiki_syntax a.edit {
  background: transparent url(./styles/proglass/theme/images/wiki/tool-edit.png) 0px 1px no-repeat;
  padding: 1px 0px 1px 20px;
  color: #436976;
}
...
div.wiki_syntax div.level1 { margin-left: 5px; padding-left: 5px; }
div.wiki_syntax div.level2 { margin-left: 10px; padding-left: 5px; }
div.wiki_syntax div.level3 { margin-left: 10px; padding-left: 5px; }
div.wiki_syntax div.level4 { margin-left: 10px; padding-left: 5px; }
div.wiki_syntax div.level5 { margin-left: 10px; padding-left: 5px; }
...
div.wiki_syntax li div.li {
	font-weight: normal;
	color: black;
}

div.wiki_syntax li p {
  margin-top: 0px;
  padding-top: 0px;
  padding-bottom: 5px;
  margin-bottom: 5px;
...
div.wiki_syntax ol {list-style-type: decimal}
div.wiki_syntax ol ol {list-style-type: upper-roman}
div.wiki_syntax ol ol ol {list-style-type: lower-alpha}
div.wiki_syntax ol ol ol ol {list-style-type: lower-greek}

div.wiki_syntax table {
  border: 0 none;	
}

div.wiki_syntax table th {
  background-image: none;
  height: 18px;
}

div.wiki_syntax table.inline {
  background-color: #ffffff;
  border-spacing: 0px;
  border-collapse: collapse;
}

div.wiki_syntax table.inline th {
  padding: 3px;
  border: 1px solid #ccc;
  background-color: #dee7ec;
}

div.wiki_syntax table.inline td {
  padding: 3px;
  border: 1px solid #ccc;
  height: 18px;
}

div.wiki_syntax pre.code,
div.wiki_syntax div.code {
...
div.wiki_syntax img.mediacenter {
  display: block;
  margin: 0 auto;
}

div.wiki_syntax img.mediaright {
  display: inline;
  float: right;
  margin: 0 0 0 1.5em;
}

div.wiki_syntax img.medialeft {
  display: inline;
  float: left;
  margin: 0 1.5em 0 0;
}

div.wiki_syntax table td,
div.wiki_syntax table th {
  vertical-align: middle;
}

div.wiki_syntax div.right_sidebar {
  width: 25%;
  float: right;
}

div.wiki_syntax div.toc_header {
  font-weight: bold;
  border: 1px solid #ccc;
  background-color: #dee7ec;
  margin-bottom: 3px;
...
div.wiki_syntax div.toc {
  border: 1px solid #ccc;
  background-color: #fff;
  padding-left: 15px;
}

div.wiki_syntax div.toc ul {
  margin-top: 0px;
  margin-bottom: 0px;
  margin-left: 10px;
  padding-left: 0px;
...
div.wiki_syntax div.toc a:link,
div.wiki_syntax div.toc a:active,
div.wiki_syntax div.toc a:visited {
  color: #436976;
}

div.wiki_syntax div.toc a:hover {
  color: #000000;
  text-decoration: underline;
}

div.wiki_syntax iframe {
  border: 1px solid #ccc;
}
/* Button Styles
---------------------------------------- */
...
ul.profile-icons li.quote-icon	{width: 42px; height: 20px;}
...
#quick_reply #message-box textarea {
	height: 150px;
}
...
.online {background-image: url("./styles/proglass/imageset/zh_cmn_hant/icon_user_online.gif")}

/* Colours and backgrounds for buttons.css
-------------------------------------------------------------- */
/* Big button images */
.reply-icon span	{background-image: url("./styles/proglass/imageset/zh_cmn_hant/button_topic_reply.gif")}
.post-icon span		{background-image: url("./styles/proglass/imageset/zh_cmn_hant/button_topic_new.gif")}
.locked-icon span	{background-image: url("./styles/proglass/imageset/zh_cmn_hant/button_topic_locked.gif")}
.pmreply-icon span	{background-image: url("./styles/proglass/imageset/zh_cmn_hant/button_pm_reply.gif")}
.newpm-icon span 	{background-image: url("./styles/proglass/imageset/zh_cmn_hant/button_pm_new.gif")}
.forwardpm-icon span	{background-image: url("./styles/proglass/imageset/zh_cmn_hant/button_pm_forward.gif")}
...
.pm-icon, .pm-icon a          {background-image: url("./styles/proglass/imageset/zh_cmn_hant/icon_contact_pm.gif")}
.quote-icon, .quote-icon a    {background-image: url("./styles/proglass/imageset/zh_cmn_hant/icon_post_quote.gif")}

/* Moderator icons */
.report-icon, .report-icon a  {background-image: url("./styles/proglass/imageset/icon_post_report.gif")}
.edit-icon, .edit-icon a      {background-image: url("./styles/proglass/imageset/zh_cmn_hant/icon_post_edit.gif")}
